        ...
        <section id="entregaveis" className="w-full py-16 sm:py-20 md:py-24 flex flex-col items-center justify-center">
          ...
          <div className="container mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl">
            <div className="overflow-hidden rounded-2xl shadow-lg hover:scale-[1.02] transition-transform duration-300 ease-out">
              <Image src="https://i.imgur.com/Jx1C80y.png" alt="Área de Membros 1" width={600} height={400} className="w-full h-full object-cover" loading="lazy" />
            </div>
            <div className="overflow-hidden rounded-2xl shadow-lg hover:scale-[1.02] transition-transform duration-300 ease-out">
              <Image src="https://i.imgur.com/X9Keoxt.png" alt="Área de Membros 2" width={600} height={400} className="w-full h-full object-cover" loading="lazy" />
            </div>
            <div className="overflow-hidden rounded-2xl shadow-lg hover:scale-[1.02] transition-transform duration-300 ease-out">
              <Image src="https://i.imgur.com/opNvdb5.png" alt="Área de Membros 3" width={600} height={400} className="w-full h-full object-cover" loading="lazy" />
            </div>
            <div className="overflow-hidden rounded-2xl shadow-lg hover:scale-[1.02] transition-transform duration-300 ease-out">
              <Image src="https://i.imgur.com/N4t7CKR.png" alt="Área de Membros 4" width={600} height={400} className="w-full h-full object-cover" loading="lazy" />
            </div>
          </div>
        </section>
        <Workflow />
