    ...
    return (
        <section id="contatos" className="container relative flex flex-col items-center justify-center py-16 lg:py-24 mb-16 lg:mb-24 overflow-hidden">
            ...
            >
                <CarouselContent>
                    {workflowSteps.map((step) => (
                        <CarouselItem key={step.step}>
                            <div className="p-1">
                                <Card className="bg-gray-deep/80 rounded-2xl border-b-4 border-gray-light/30 text-left h-full">
                                    <CardContent className="flex flex-col lg:flex-row justify-center items-start lg:items-center p-8 lg:p-12 gap-8 lg:gap-16">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-medium text-base lg:text-lg leading-relaxed">{step.description}</p>
                                        </div>
                                    </CardContent>
                                </Card>
                            </div>
                ...
                <CarouselPrevious className="hidden lg:flex bg-gray-deep hover:bg-gray-medium border-gray-medium/30 text-white" />
                <CarouselNext className="hidden lg:flex bg-gray-deep hover:bg-gray-medium border-gray-medium/30 text-white" />
            </Carousel>
        </section>
    );
}
